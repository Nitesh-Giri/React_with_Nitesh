...
const Features =() => {
    ...
    return (
       <>
       <div class="mx-auto max-w-7xl px-2 lg:px-8 m-4 py-8">
       <div class="flex justify-center items-center">
        <h1 class="text-4xl font-bold text-center">Features</h1>
        <hr></hr>
        </div>
  <div class="grid grid-cols-1 gap-y-8 text-center sm:grid-cols-2 sm:gap-12 lg:grid-cols-4 m-12 shadow-sm">
